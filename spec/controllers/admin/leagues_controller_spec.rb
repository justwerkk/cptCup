...
describe Admin::LeaguesController do
  ...
  let(:valid_attributes) { attributes_for(:league) }
    ...
    describe "POST create" do
      ...
      describe "with invalid params" do
        it "assigns a newly created but unsaved league as @league" do
          ...
          post :create, {:league => {  }}, valid_session
          assigns(:league).should be_a_new(League)
        end
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested league" do
          ...
          League.any_instance.should_receive(:update_attributes).with({"name" => "New Name"})
          put :update, {:id => league.to_param, :league => {"name" => "New Name"}}, valid_session
        end
      ...
      describe "with invalid params" do
        it "assigns the league as @league" do
          ...
          # Trigger the behavior that occurs when invalid params are submitted
          League.any_instance.stub(:save).and_return(false)
          put :update, {:id => league.to_param, :league => {  }}, valid_session
          assigns(:league).should eq(league)
        end
